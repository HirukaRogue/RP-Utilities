...
### ROLL MACRO ###
##################
async def roll(args, res_type: str):
    ...
    if not_failure:
        ...
        return resp_total if res_type == "only_string" else total if res_type == "only_result" else list(resp_total, total)
...
### MATH MACRO ###
##################
async def math(args: str, res_type: str):
    result = sympify(args)
    ...
    if res_type == "only_result":
        ...
        return list(result_string, result)


####################
### SELECT MACRO ###
####################
async def select(*args: str):
